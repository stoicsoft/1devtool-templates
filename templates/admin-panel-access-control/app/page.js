const appNav = [
  ...
  { icon: "issues", label: "Users", count: 18, active: true },
  { icon: "pr", label: "Approval queue", count: 7 },
  { icon: "templates", label: "Roles" },
  { icon: "insights", label: "Audit logs" },
  { icon: "docs", label: "Runbooks" },
  { icon: "automations", label: "Policies" },
      ...
      <main className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="flex h-12 shrink-0 items-center gap-3 border-b border-[var(--color-line)] bg-white px-4">
          <div className="flex min-w-0 items-center gap-1.5 text-[13px] text-gray-500">
            <span className="font-medium text-gray-700">Northstar</span>
            <Icon name="chevron-right" className="h-3 w-3 text-gray-300" />
            <span>Identity</span>
            <Icon name="chevron-right" className="h-3 w-3 text-gray-300" />
            <span className="font-semibold text-[var(--color-ink)]">Pending approvals</span>
          </div>
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button className="inline-flex h-8 items-center gap-1.5 rounded-md bg-[var(--color-indigo)] px-2.5 text-[12.5px] font-medium text-white hover:bg-[var(--color-indigo-2)]">
              <Icon name="plus" className="h-3.5 w-3.5" /> New policy
            </button>
          </div>
        </div>
